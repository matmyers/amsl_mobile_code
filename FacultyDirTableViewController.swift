...
class FacultyDirTableViewController: UITableViewController, UISearchBarDelegate {
    
    // set url to where json data is read
    private final let urlString = "https://matmyers.github.io/amsl_mobile/mobileAppFacultyDir.json"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "FacultyDirectoryTableViewCell") as! FacultyDirectoryTableViewCell
